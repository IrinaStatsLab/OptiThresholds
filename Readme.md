...
### R package OptiThresholdR
The corresponding R package `OptiThresholdR` (GPL-3 license) can also be downloaded from GitHub:
```r
...
**Dependencies**: `numpy`, `pandas`, and `scipy >= 1.12.0`.
...
See [experiments/Reproducing.md](experiments/Reproducing.md) for instructions.  

For the AI-READI raw-data preprocessing layout and commands, see [`data/AI_READI_processing_guide.md`](data/AI_READI_processing_guide.md).
